...
function InviteButton() {
    ...
    return (
        <button
            type="submit"
            disabled={pending}
            className="w-full rounded-md bg-blue-600 px-4 py-2 text-sm text-white shadow-sm transition-colors hover:bg-blue-700 active:bg-blue-800 disabled:cursor-not-allowed disabled:opacity-50 md:w-max"
        >
            {pending ? (
    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="mt-1 text-sm text-gray-600 dark:text-zinc-400">Invite collaborators to help manage this event.</p>
            </div>
            ...
            <div>
                <h3 className="font-medium text-gray-900 dark:text-zinc-100">Current Admins</h3>
